import { getEVMGasTypeForTransaction, EVMGasType, TransactionGasDetails, NetworkName, FeeTokenDetails, TXIDVersion, RailgunERC20Amount } from "@railgun-community/shared-models";
import { gasEstimateForUnprovenUnshieldBaseToken } from "@railgun-community/wallet";
...
export async function getGasEstimateForUnprovenUnshieldBaseToken(
  network: NetworkName,
